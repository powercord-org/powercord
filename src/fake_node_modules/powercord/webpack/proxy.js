...
function commandHandler (cmd, ...args) {
  switch (cmd) {
    case 'getModule':
      return serialize(getModule(args[0], args[1], args[2]));
    case 'getModuleByDisplayName':
      return serialize(getModuleByDisplayName(args[0], args[1], args[2]));
    case 'getModuleByDisplayNameRaw':
      return serialize(getModuleByDisplayNameRaw(args[0], args[1], args[2], args[3]));
    case 'getAllModules':
      return serialize(_getModules(args[0], true));
    case 'getWindowProps':
...
window.$PowercordWebpack = {
  getModule: (a, b, c) => getModule(a, b, c),
  getAllModules: (a) => _getModules(a, true),
  getModuleByDisplayName: (a, b, c) => getModuleByDisplayName(a, b, c)
};
