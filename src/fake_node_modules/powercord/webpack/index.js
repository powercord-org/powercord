...
const { deserialize, setCommandHandler } = require('./serialize.js');
...
function getModuleByDisplayName (displayName, retry = true, forever = false) {
  return getModule((m) => m.displayName?.toLowerCase() === displayName.toLowerCase(), retry, forever);
}
...
contextBridge.exposeInMainWorld('__$$PowercordWebpackIPC', {
