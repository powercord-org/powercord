...
module.exports = class Webpack {
  ...
  static getModule (filter, retry = true) {
    ...
    if (!retry) {
      const mdl = Webpack._getModules(filter);
      return mdl ? mdl.exports.default || mdl.exports || null : null;
    }
    ...
    return new Promise(async (res) => {
      ...
      for (let i = 0; i < 21; i++) {
        ...
        if (mdl) {
          return res(mdl ? mdl.exports.default || mdl.exports || null : null);
        }
        await sleep(200);
      }
  ...
  static async init () {
    ...
    for (const mdl in moduleFilters) {
      ...
      exports[mdl] = await Webpack.getModule(moduleFilters[mdl]);
    }
  }
  ...
  static _getModules (filter, all = false) {
    ...
    return all ? moduleInstances.filter(filterFunction) : moduleInstances.find(filterFunction);
  }
};
