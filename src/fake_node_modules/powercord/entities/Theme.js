    ...
    return new Promise((res, rej) => {
      renderSCSS({
        ...
        importer: (url, prev) => {
          ...
          const prevFile = prev === 'stdin' ? this._theme : prev.replace(/https?:\/\/(?:[a-z]+\.)?discord(?:app)?\.com/i, '');
          return {
        ...
        res({
          ...
          includes: [
            this._theme,
            ...compiled.stats.includedFiles.map(f => decodeURI(f).replace(/\\/g, '/').replace(/https?:\/\/(?:[a-z]+\.)?discord(?:app)?\.com/i, ''))
          ]
        });
      });
    });
