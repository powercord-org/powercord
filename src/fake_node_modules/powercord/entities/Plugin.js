...
module.exports = class Plugin extends Updatable {
  ...
  registerToast ({ id, header, content, type, style, icon, imageClassName, buttons, callback }) {
    this.registered.toasts.push(id);
    powercord.api.toasts.registerToast(id, header, content, type, icon, style, imageClassName, buttons, callback);
  }
