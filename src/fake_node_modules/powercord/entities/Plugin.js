...
// @todo: make it
const MIGRATION_GUIDE_URL = 'https://printer.discord.com';
...
class Plugin extends Updatable {
  ...
  loadStylesheet (path) {
    ...
    const style = createElement('style', { id: `style-${this.entityID}-${id}` });
  ...
  registerSettings (section, displayName, render, connectStore = true) {
    this.warn(`DEPRECATION WARNING: The method registerSettings is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  registerCommand (command, aliases, description, usage, func, autocompleteFunc) {
    this.warn(`DEPRECATION WARNING: The method registerCommand is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  registerKeybind (id, name, description, func, keybind, global = false) {
    this.warn(`DEPRECATION WARNING: The method registerKeybind is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  updateKeybind (id, keybind) {
    this.warn(`DEPRECATION WARNING: The method updateKeybind is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
    this.registered.keybinds.push(id);
  ...
  registerRoute (path, render, noSidebar = false) {
    this.warn(`DEPRECATION WARNING: The method registerRoute is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  /** @deprecated */
  sendToast (id, props) {
    this.warn(`DEPRECATION WARNING: The method sendToast is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  /** @deprecated */
  closeToast (id) {
    this.warn(`DEPRECATION WARNING: The method closeToast is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  sendAnnouncement (id, props) {
    this.warn(`DEPRECATION WARNING: The method sendAnnouncement is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  closeAnnouncement (id) {
    this.warn(`DEPRECATION WARNING: The method closeAnnouncement is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  registerRPCScope (scope, grant) {
    this.warn(`DEPRECATION WARNING: The method registerRPCScope is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  unregisterRPCScope (scope) {
    this.warn(`DEPRECATION WARNING: The method unregisterRPCScope is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  registerRPCEvent (event, handler) {
    this.warn(`DEPRECATION WARNING: The method registerRPCEvent is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  unregisterRPCEvent (event) {
    this.warn(`DEPRECATION WARNING: The method unregisterRPCEvent is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
  ...
  /** @deprecated */
  loadCSS (id, path) {
    this.warn(`DEPRECATION WARNING: The method loadCSS is deprecated and should no longer be used. See the migration guides: ${MIGRATION_GUIDE_URL}`);
    if (path === void 0) {
      path = id;
      id = this.entityID;
    }
    ...
    // The loadPluginCSS should be yeeted along with this function
