...
class Plugin extends Updatable {
  ...
  _deprecationWarning (method) {
    ...
    console.warn(`%c[${this.constructor.name}] DEPRECATION WARNING%c: ${method} is deprecated and is scheduled for removal on %cNovember 1st, 2020%c. Please refer to the migration guide to update your plugin before the end of the deprecation period: https://printer.discord.com`, 'color: #f04747', '', 'font-weight: bold', 'font-weight: normal');
  }
}
