                ...
                this.props.buttons.filter(Boolean).map(button => (
                  <Button
                    ...
                    size={button.size && this.objectHasKey(button.size, Button.Sizes)
                      ...
                      : Button.Sizes.SMALL}
                    color={button.danger ? Button.Colors.RED : button.color && this.objectHasKey(button.color, Button.Colors)
                    ...
                    look={button.danger ? Button.Looks.OUTLINED : button.type && this.objectHasKey(button.type, Button.Looks)
                      ...
                      : Button.Looks.FILLED}
                    hover={button.hoverColor && this.objectHasKey(button.hoverColor, Button.Hovers)
