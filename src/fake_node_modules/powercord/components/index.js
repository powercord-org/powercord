...
Object.assign(exports, {
  ...
  Mask: AsyncComponent.from(getModuleByDisplayName('Mask'))
});
...
(async () => {
  ...
  const Mask = await getModuleByDisplayName('Mask', true, true);
  ...
  [ 'Masks' ].forEach(prop => exports.Mask[prop] = Mask[prop]);
