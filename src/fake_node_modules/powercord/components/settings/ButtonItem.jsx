...
module.exports = class ButtonItem extends React.Component {
  ...
  async componentDidMount () {
    ...
    classes = {
      ...
      classDivider: (await getModule([ 'divider' ])).divider,
  ...
  render () {
    return <DFormItem
      ...
      <div className='powercord-settings-item-title'>
        ...
        <Button style={{ marginLeft: 5 }} onClick={() => this.props.onClick()}>{this.props.button}</Button>
      </div>
