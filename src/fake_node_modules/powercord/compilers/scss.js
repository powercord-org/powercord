      ...
      readFile(this.file, 'utf8').then(rawScss => {
        sass.render({
          ...
          importer: (url, _, cb) => {
            ...
            /*
             * Through Kanin's experience it seems sass is a piece of garbage and
             * can't properly load files. Even this needs spoonfeeding smh
             */
            readFile(file, 'utf8').then(contents => cb({ contents }));
          }
        }, (err, compiled) => {
          if (err) {
            return reject(err);
