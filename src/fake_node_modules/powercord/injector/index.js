...
const injector = {
  ...
  injectRecursive: (injectionId, root, paths, func) => new Promise(resolve => {
    console.warn('[Injector::injectRecursive] This method is deprecated and will be removed in future versions of Powercord');
  ...
  injectInFluxContainer: (injectionId, componentName, funcName, patch) => new Promise(resolve => {
    console.warn('[Injector::injectInFluxContainer] This method is deprecated and will be removed in future versions of Powercord');
